        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnergyRequirement = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealDays_Recipes_BreakfastId",
                        column: x => x.BreakfastId,
                        principalTable: "Recipes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MealDays_Recipes_DinnerId",
                        column: x => x.DinnerId,
                        principalTable: "Recipes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MealDays_Recipes_LunchId",
                        column: x => x.LunchId,
                        principalTable: "Recipes",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SnackDays", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealDays_BreakfastId",
                table: "MealDays",
                column: "BreakfastId");

            migrationBuilder.CreateIndex(
                name: "IX_MealDays_CoachId",
                table: "MealDays",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_MealDays_DinnerId",
                table: "MealDays",
                column: "DinnerId");

            migrationBuilder.CreateIndex(
                name: "IX_MealDays_LunchId",
                table: "MealDays",
                column: "LunchId");

            migrationBuilder.CreateIndex(
                name: "IX_MealDays_UserId",
                table: "MealDays",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SnackDays_SnackId",
                table: "SnackDays",
                column: "SnackId");

            migrationBuilder.CreateIndex(
                name: "IX_SnackDays_UserId",
                table: "SnackDays",
                column: "UserId");
